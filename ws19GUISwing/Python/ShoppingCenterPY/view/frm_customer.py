...
import model.Customer as customer_module
from tkinter import ttk, messagebox

class FrmCustomer(tk.Tk):
    def __init__(self):
        super().__init__()
        ...
        self.sld_age = tk.Scale(frame, from_=0, to=113, orient="horizontal", command=self._on_scale)
        ...
        self.cmb_type = ttk.Combobox(frame, values=["Frequent", "Ocasional", "Friend","Preferencial"], state="readonly")
